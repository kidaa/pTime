...
int main(int argc, char *argv[])
{
    ...
    char *pathTrajtIn,*pathTrajtOut,*pathForcePrevIn,*pathForceNextIn,*pathNWOut,*pathForceOut,*tTrajtIn,*tTrajtOut,*tForcePrevIn,*tForceNextIn,*tForceOut,*tNWOut;
    ...
    // [MAY 30, 2014] - Add the conditional statement. ForcePrev takes _1.nw file only at ind = 0
    if(ind == 0)
