...
int main(int argc, char *argv[])
{
    ...
    int *ID,numPart,i,ind,optInd,optCount,isLastStep,TOptionIndex,dtPathIndex;
    ...
    char *pathTrajOut,*pathPropOut /* SAVED FOR LATER VERSIONS TO OUTPUT PROPERTIES!! */;
    ...
    while(optInd < argc)
    {
        ...
        // [AUGUST 11, 2014] - This option dictates whether the program should scale T??
    ...
    strcpy(pathForcePrevIn,argv[dtPathIndex]);
    strcpy(pathForceNextIn,argv[dtPathIndex]);
    strcpy(pathForceOut,argv[dtPathIndex]);
    strcpy(pathNWOut,argv[dtPathIndex]);
    strcpy(pathTrajOut,argv[dtPathIndex]);
    ...
    if((strcmp(argv[TOptionIndex],"Y")==0)||(strcmp(argv[TOptionIndex],"y")==0))
    {
        ...
        strcpy(pathTempOut,argv[dtPathIndex]);
    ...
    //writeNW(coord,name,numPart,pathNWOut,pathForceOut,argv[dtPathIndex]);
