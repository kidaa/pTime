...
{
    int optInd, optCount, dtPrefixIndex, numNodes, i;
    ...
    strcpy(pathInitial,argv[dtPrefixIndex]);
    strcpy(pathMain,argv[dtPrefixIndex]);
    strcpy(pathFinal,argv[dtPrefixIndex]);
    ...
    for(i = 0; i < numNodes; i++)
    {
        ...
        fprintf(confMain,"%d   /scratch/nwchem %scopy%d/input%d.nw\n",i,argv[dtPrefixIndex],i+1,i+1);
