...
int main(int argc, char *argv[])
{
    ...
    int optInd,optCount,dirPrefixIndex,dtPathIndex;
    ...
    writeNW(tcoord,elemName,numPart,pathNWOutConv,pathForceOutConv,argv[dirPrefixIndex],argv[dtPathIndex]);
    ...
    for(i = 0; i < M; i++)
    {
        ...
        writeNW(tcoord,elemName,numPart,pathNWOutNConv,pathForceOutNConv,argv[dirPrefixIndex],argv[dtPathIndex]);
    }
