...
int main(int argc, char *argv[])
{
    ...
    int *ID,numPart,i,ind,optInd,optCount,dtPathIndex;
    char **name;
    ...
    while(optInd < argc)
    {
        ...
        // [JUNE 19, 2014] - Added "-D" dtemp option
    ...
    writeNW(coordNext,name,numPart,pathNWOut,pathForceOut,dirPrefix,argv[dtPathIndex]);
